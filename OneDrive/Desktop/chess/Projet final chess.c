...
void bishop(int, int, int); // Fonction ajoutée pour le fou
...
{
    if (current_player == 1) {
        return piece >= 'a' && piece <= 'z'; // Joueur 1 peut capturer les pièces en minuscules
    } else {
        return piece >= 'A' && piece <= 'Z'; // Joueur 2 peut capturer les pièces en majuscules
    }
}
